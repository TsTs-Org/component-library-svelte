...
>
	...
	const modeValues = {
		lightValues: {
			...
			text_color_muted: "oklch(from var(--neutral-800) l c h / 0.75)",
		...
		darkValues: {
			...
			text_color_muted: "oklch(from var(--neutral-200) l c h / 0.75)",
			text_color_inverted: "var(--neutral-200)",
		...
		(() => {
			...
			const defaults = {
				...
				lightValues: {
					...
					foreground_color: "var(--neutral-200)",
					text_color: "var(--neutral-800)",
					text_color_muted: "oklch(from var(--neutral-500) l c h / 0.75)",
					text_color_inverted: "var(--neutral-200)",
					border_color: "var(--neutral-400)",
